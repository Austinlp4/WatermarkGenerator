...
const SignUp = () => {
  ...
  return (
    <>
      <SEO 
        title="Sign Up"
        description="Create your Watermark Generator account and start protecting your images with professional watermarks today."
        canonicalUrl="https://watermark-generator.com/signup"
      />
